...
namespace OKeeffeCraft.Core.Services
{
    public class AMLAssistantService : IAMLAssistantService
    {
        ...
        {
            return await _chatGptService.RetriveMessage(threadId, messageId);
        }
        ...
        {
            return await _chatGptService.CreateRun(message);
        }
        ...
        {
            return await _chatGptService.GetThreadMessages(threadId);
        }
